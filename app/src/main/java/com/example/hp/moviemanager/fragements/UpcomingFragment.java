package com.example.hp.moviemanager.fragements;
...
import com.example.hp.moviemanager.adapters.MovieRecyclerViewAdapter;
...
public class UpcomingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MovieRecyclerViewAdapter adapter = new MovieRecyclerViewAdapter(movies,this.getContext());
